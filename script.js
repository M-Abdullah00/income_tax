document.addEventListener('DOMContentLoaded', function () {
    ...
    function calculateTax() {
        ...
        const houseRentValues = {
            30: [0, 1337, 1367, 1413, 1458, 1503, 1544, 1589, 1650, 1719, 1781, 1853, 1961, 2091, 2214, 2349, 2727, 4433, 5810, 8856, 10506, 10506], // index 0 is 'None'
            45: [0, 2006, 2049, 2120, 2187, 2255, 2316, 2384, 2474, 2579, 2670, 2778, 2940, 3135, 3321, 3524, 4091, 6650, 8715, 13284, 15758, 15758], // index 0 is 'None'
        };
        ...
        document.getElementById('annualSalary').textContent = 'Rs ' + annualSalary;
document.getElementById('annualAdditions').textContent = 'Rs ' + annualAdditions;
document.getElementById('taxRate').textContent = effectiveTaxRate.toFixed(2) + '%';
document.getElementById('annualTax').textContent = 'Rs ' + annualTax;
